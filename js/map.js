...
map.addControl(mapTypeControl, kakao
    .maps
    .ControlPosition
    .TOPRIGHT);
var zoomControl = new kakao.maps.ZoomControl();
map.addControl(zoomControl, kakao
    .maps
    .ControlPosition
    .RIGHT);
map.addOverlayMapTypeId(kakao
    .maps
    .MapTypeId
    .TERRAIN);
// 주소 변환 객체
    ...
    .addListener(map, 'click', function (mouseEvent) {
        ...
        geocoder.coord2Address(latlng.getLng(), latlng.getLat(), function (result, status) {
            if (status === kakao
                ...
                document.getElementById('clickLatlng').innerHTML = '클릭한 위치의 위도는 ' + latlng.getLat() + ' 이고, 경도는 ' + latlng.getLng() + ' 입니다';
            }
        });
    });
// 장소 검색
